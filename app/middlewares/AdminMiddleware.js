        ...
        try {
            JsonWebToken.verify(
                ...
                function (error, decoded) {
                    ...
                    if (decoded.userRole !== Constant.USER_ROLE.ADMIN) {
                        ...
                        return Rest.sendError(
                            ...
                            "unauthorized",
                            403,
                            "User is not authorized (requires admin role)"
                        );
                    }
                    ...
                    UserManager.verifyUser(
                        ...
                        function (
                            ...
                            // Since user is verified as admin, continue processing the request (original logic)
                            if (req.method === "GET") {
