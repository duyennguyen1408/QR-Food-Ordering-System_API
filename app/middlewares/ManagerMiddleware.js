        ...
        try {
            JsonWebToken.verify(
                ...
                function (error, decoded) {
                    ...
                    if (decoded.userRole < Constant.USER_ROLE.MANAGER) {
                        ...
                        return Rest.sendError(
                            ...
                            "unauthorized",
                            403,
                            "User is not authorized (requires admin or manager role)"
                        );
                    }
                    ...
                    UserManager.verifyUser(
                        ...
                        function (
                            ...
                            // Since user is verified as admin/manager, continue processing the request (original logic)
                            if (req.method === "GET") {
