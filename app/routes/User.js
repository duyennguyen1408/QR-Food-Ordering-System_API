...
module.exports = function (app) {
    ...
    app.post("/v1/auth/create", AdminMiddleware, UserCtrl.createManager);
    app.post("/v1/auth/create-staff", ManagerMiddleware, UserCtrl.createStaff);
     ...
     *     }
     */
    app.get("/v1/auth/users/:id", ManagerMiddleware, UserCtrl.getOne);
     ...
     *     }
     */
    app.get("/v1/auth/users", ManagerMiddleware, UserCtrl.getAll);
     ...
     *     }
     */
    app.put("/v1/auth/users/:id", ManagerMiddleware, UserCtrl.update);
     ...
     *     }
     */
    app.delete("/v1/auth/users/:id", ManagerMiddleware, UserCtrl.delete);
};
